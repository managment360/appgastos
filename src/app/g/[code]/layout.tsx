...
import { getGroupByCode, getMembers, getActivity } from "@/db/queries";
...
import { ClaimGuard } from "@/components/group/claim-guard";
...
export default async function GroupLayout({
  ...
  return (
    <div className="mx-auto flex min-h-dvh w-full max-w-md flex-col overflow-x-clip bg-background shadow-sm">
      ...
      <ClaimGuard code={group.code} members={members} />
      <WhoAreYou code={group.code} members={members.filter((m) => m.active)} />
      <GroupTopbar group={group} members={members} activity={activity} />
